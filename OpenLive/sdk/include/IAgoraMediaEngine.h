...
class IVideoFrameObserver {
 ...
 public:
  ...
  /** Retrieves the video image before encoded, all the pre-processing has been done such as beauty/scale/crop etc.

   @param videoFrame VideoFrame The video frame's parameters are same with the encoded parameters.
   */
  virtual bool onPreEncoderVideoFrame(VideoFrame& videoFrame) = 0;
...
class IMediaEngine {
 public:
  ...
  /** Registers a video frame observer object.
   ...
   This method is required to register callbacks when the engine is required to provide an \ref IVideoFrameObserver::onCaptureVideoFrame "onCaptureVideoFrame" or \ref IVideoFrameObserver::onPreEncoderVideoFrame "onPreEncoderVideoFrame" or \ref IVideoFrameObserver::onRenderVideoFrame "onRenderVideoFrame" callback.
