...
ENGLISH_API LPCTSTR IDS_ENCODE_SOFTWARE = _T("Software Encode");
ENGLISH_API LPCTSTR IDS_ENCODE_INTEL = _T("Intel   Encode");
ENGLISH_API LPCTSTR IDS_ENCODE_NVIDIA = _T("Nvidia   Encode");
...
ENGLISH_API LPCTSTR IDS_VIDEO_MORESEI = _T("Setup");
